...
def test_website_login_standard_user(set_up_page: Page):
    delete_storage_file("screen_shoot/screen_shoot/website_login_standard_user.png")
    ...
    set_up_page.screenshot(path="screen_shoot/screen_shoot/website_login_standard_user.png")
    # set_up_page.close()

def test_website_login_performance_glitch_user(set_up_page: Page):
    delete_storage_file("screen_shoot/screen_shoot/website_login_performance_glitch_use.png")
    logger.info(msg="Input Username")
    ...
    set_up_page.locator("//input[@id='login-button']").click()
    assert set_up_page.locator("//div[@class='app_logo']").is_visible()
    set_up_page.screenshot(path="screen_shoot/screen_shoot/website_login_performance_glitch_use.png", full_page=True)
    # set_up_page.close()
